...
int main()
{
    ...
    strcpy(user_array[1].name , "Akshay Kumar");
    strcpy(user_array[2].name , "Shah Rukh Khan");
    strcpy(user_array[3].name , "Ronaldo");
    strcpy(user_array[4].name , "Messi");

    strcpy(user_array[5].name , "Aditya");
    strcpy(user_array[6].name , "Archit");
    strcpy(user_array[7].name , "Harsh");
    strcpy(user_array[8].name , "Neymar");
    strcpy(user_array[9].name , "Hazard");
    strcpy(user_array[10].name , "Alia Bhatt");
    strcpy(user_array[11].name , "Deepika Padukone");

    strcpy(user_array[12].name , "Kohli");

    strcpy(user_array[13].name , "Dhoni");

    strcpy(user_array[14].name , "Tendulkar");

    strcpy(user_array[15].name , "Pandya");
    ...
    strcpy(user_array[1].bio , "actor  from india");

    strcpy(user_array[2].bio , "actor from india");

    strcpy(user_array[3].bio , "football player from portugal");

    strcpy(user_array[4].bio , "football from argentina");

     strcpy(user_array[5].bio , "student at vit");
     strcpy(user_array[6].bio , "student at vit");
     strcpy(user_array[7].bio , "student at vit");
    strcpy(user_array[8].bio , "football player from brazil");
    strcpy(user_array[9].bio , "football player from belgium");
    strcpy(user_array[10].bio , "actress  from india");
    strcpy(user_array[11].bio , "actress  from india");

     strcpy(user_array[12].bio , "Indian cricket player");
     strcpy(user_array[13].bio , "Indian cricket player");
     strcpy(user_array[14].bio , "Indian cricket player");
     strcpy(user_array[15].bio , "Indian cricket player");
...
Enter you new bio:student at viit
...
PrintIng the details of user:
NAME:Ronaldo
BIO: football player from portugal
Friends:
Hazard
  Messi
  Neymar
...
PrintIng the details of user:
NAME:Neymar
BIO: football player from brazil
Friends:
Hazard
  Messi
  Ronaldo
...
PrintIng the details of user:
NAME:Hazard
BIO: football player from belgium
Friends:
Neymar
  Messi
  Ronaldo
...
You have not added any friends ! Please add some friends!
...
You are a new user . Please add some friends so that we can suggest you better
 Tweetbook Users:
  PrintIng the details of user:
NAME:abhishek
BIO: student at vit
...
7. Terminate program
 ...
 Suggesting Friends...
 Possible friends from abhishek are -- Harsh
 Archit
 Aditya
...
Archit
Harsh
Enter Friend's name:Harsh
adding Harsh!
 Print 1 if you want to add another friend:1


 Suggesting Friends...
 Possible friends from Harsh are -- Archit
 Aditya

Possible friends from abhishek are -- Archit
 Aditya

SUGGESTED FOR YOU:
Aditya
Archit
Enter Friend's name:Archit
adding Archit!
...
Process returned 1 (0x1)   execution time : 23.845 s
